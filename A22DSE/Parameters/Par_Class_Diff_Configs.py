...
Conv.ParStruc.MTOW, Conv.ParStruc.FW, Conv.ParAnFP.S, Conv.ParAnFP.Thrust, Conv.ParAnFP.TtoW, Conv.ParAnFP.WS  = WSandTW(False,Conv,ISA_model)
...
while error > 10e-3:
    ...
    Conv.ParAnFP.TtoW, Conv.ParAnFP.WS  = WSandTW(False,Conv,ISA_model)
