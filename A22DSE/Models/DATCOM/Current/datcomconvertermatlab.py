...
def PrintMatlab():
    ...
    CHSTAT_WG = 0.0
    TWISTA_WG = round(float(Conv.ParAnFP.twwing),10)
    DHDADI_WG = round(float(Conv.ParAnFP.dhwing),10)
    TC_WG=0.12
    ...
    CHSTAT_HT = 0.25
    TWISTA_HT = round(float(Conv.ParAnFP.twht),10)
    DHDADI_HT = round(float(Conv.ParAnFP.dhht),10)
