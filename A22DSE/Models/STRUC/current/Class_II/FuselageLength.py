...
def Fuselage(Conv):
    a = GetTotalFuselageLength(Conv, Conv.ParLayoutConfig.x_lemac+Conv.ParLayoutConfig.x_oe*Conv.ParAnFP.MAC+max(Conv.ParLayoutConfig.xvt, Conv.ParLayoutConfig.xht), 2, 0.01)
    return a
